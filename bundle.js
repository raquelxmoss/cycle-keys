...
function main(_ref) {
  ...
  var colours = ["#F6F792", "#333745", "#77C4D3", "#DAEDE2", "#EA2E49"];

  var isDown$ = Keys.isDown('space').startWith(false);

  var colour$ = Keys.press('enter').map(function (ev) {
    return +1;
  }).scan(function (acc, int) {
    return acc + int;
  }, 0).startWith(0).map(function (int) {
    return colours[int % colours.length];
  });

  var state$ = (0, _rxCombineLatestObj2.default)({ isDown$: isDown$, colour$: colour$ });

  return {
    DOM: state$.map(function (state) {
      return (0, _dom.div)('.container', { style: { background: state.colour } }, [(0, _dom.h1)(state.isDown ? "Oooh fancy!" : "Hold down the space bar. Go on, I dare you."), (0, _dom.p)("For additional fun, hit enter")]);
    })
  };
}

},{"@cycle/dom":4,"rx":27,"rx-combine-latest-obj":26}],2:[function(require,module,exports){
'use strict';

var _core = require('@cycle/core');

var _keysDriver = require('../../src/keys-driver');
...
var drivers = {
  ...
  Keys: (0, _keysDriver.makeKeysDriver)()
};

(0, _core.run)(app, drivers);

},{"../../src/keys-driver":66,"./app":1,"@cycle/core":3,"@cycle/dom":4,"rx":27}],3:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":6,"./render-dom":7,"./render-html":8,"./virtual-hyperscript":11,"./virtual-hyperscript-svg":10,"hyperscript-helpers":17}],5:[function(require,module,exports){
"use strict";
...
},{"rx":27}],6:[function(require,module,exports){
'use strict';
...
},{"rx":27}],7:[function(require,module,exports){
"use strict";
...
},{"./fromevent":5,"./transposition":9,"./virtual-hyperscript":11,"matches-selector":23,"rx":27,"vdom-parser":32,"virtual-dom/diff":39,"virtual-dom/patch":40}],8:[function(require,module,exports){
"use strict";
...
},{"./transposition":9,"rx":27,"vdom-to-html":36}],9:[function(require,module,exports){
"use strict";
...
},{"rx":27,"virtual-dom/vnode/vnode":59}],10:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":11,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":47,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":51,"x-is-array":64}],11:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":48,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":49,"virtual-dom/virtual-hyperscript/parse-tag.js":50,"virtual-dom/vnode/is-thunk":53,"virtual-dom/vnode/is-vhook":54,"virtual-dom/vnode/is-vnode":55,"virtual-dom/vnode/is-vtext":56,"virtual-dom/vnode/is-widget":57,"virtual-dom/vnode/vnode.js":59,"virtual-dom/vnode/vtext.js":61,"x-is-array":64}],12:[function(require,module,exports){
...
},{"min-document":12}],17:[function(require,module,exports){
'use strict';
...
},{"sentence-case":28}],25:[function(require,module,exports){
...
},{"rx":27}],27:[function(require,module,exports){
...
},{"_process":25}],28:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":29,"./vendor/non-word-regexp":30,"./vendor/trailing-digit-regexp":31,"lower-case":22}],29:[function(require,module,exports){
...
},{"./namespace-map":33,"./property-map":34,"virtual-dom/vnode/vnode":59,"virtual-dom/vnode/vtext":61}],33:[function(require,module,exports){
...
},{"./property-config":37,"escape-html":14}],36:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":35,"./void-elements":38,"escape-html":14,"param-case":24,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":47,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":49,"virtual-dom/vnode/is-thunk":53,"virtual-dom/vnode/is-vnode":55,"virtual-dom/vnode/is-vtext":56,"virtual-dom/vnode/is-widget":57,"xtend":65}],37:[function(require,module,exports){
/**
 * Attribute types.
 */
...
},{"../vnode/is-vhook.js":54,"is-object":20}],42:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":52,"../vnode/is-vnode.js":55,"../vnode/is-vtext.js":56,"../vnode/is-widget.js":57,"./apply-properties":41,"global/document":16}],43:[function(require,module,exports){
...
},{"../vnode/is-widget.js":57,"../vnode/vpatch.js":60,"./apply-properties":41,"./update-widget":46}],45:[function(require,module,exports){
var document = require("global/document")
var isArray = require("x-is-array")
...
},{"./create-element":42,"./dom-index":43,"./patch-op":44,"global/document":16,"x-is-array":64}],46:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":15}],49:[function(require,module,exports){
'use strict';
...
},{"browser-split":13}],51:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":54,"is-object":20}],63:[function(require,module,exports){
var isArray = require("x-is-array")
